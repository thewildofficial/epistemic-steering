...
\paragraph{GSM8K.}
We use 200 questions from the GSM8K grade-school math benchmark. These require multi-step arithmetic reasoning. The model answered 7 of 200 questions correctly (3.5\%), indicating that Qwen3.5-4B performs poorly on this task under the raw-text prompting format used in our data extraction.
